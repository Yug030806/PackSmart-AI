  ...
  return (
    <div style={{
      ...
      <div className="glass-card" style={{
        ...
        boxShadow: "0 25px 60px rgba(23, 34, 29, 0.25)"
      }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            <b style={{ color: "var(--color-primary-dark)", fontSize: "14px" }}>PackSmart AI Packaging Specification Report</b>
          </div>
        ...
        <div style={{ overflowY: "auto", padding: "32px", fontSize: "13px", color: "var(--color-primary-dark)" }} id="printable-report">
          {/* Header Banner */}
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", borderBottom: "2px solid var(--color-muted-green)", paddingBottom: "18px", marginBottom: "24px" }}>
            <div>
              <div className="micro-label green">Technical Assessment & Engineering Report</div>
              <h2 style={{ fontSize: "24px", fontWeight: 800, color: "var(--color-primary-dark)", margin: "4px 0" }}>PackSmart AI Recommendation Specification</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "18px", marginBottom: "20px" }}>
            <div style={{ background: "var(--color-bg-base)", padding: "14px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-color)" }}>
              <b style={{ color: "var(--color-muted-green)", fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.05em", display: "block", marginBottom: "8px" }}>
                1. Food Commodity Profile
              </b>
              <div>Commodity Name: <b style={{ color: "var(--color-primary-dark)" }}>{foodName}</b></div>
            ...
            <div style={{ background: "var(--color-bg-base)", padding: "14px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-color)" }}>
              <b style={{ color: "var(--color-data-slate)", fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.05em", display: "block", marginBottom: "8px" }}>
          ...
          <div style={{ background: "var(--color-bg-base)", padding: "16px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-color)", marginBottom: "20px" }}>
            <b style={{ color: "var(--color-muted-green)", fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.05em", display: "block", marginBottom: "6px" }}>
            ...
            <div style={{ fontSize: "12.5px", color: "var(--color-primary-dark)", lineHeight: "1.5", marginBottom: "12px" }}>
            ...
            <div style={{ paddingTop: "10px", borderTop: "1px solid var(--border-color)" }}>
              <b style={{ color: "var(--color-primary-dark)", fontSize: "12.5px", display: "block", marginBottom: "4px" }}>
                Why this material?
              </b>
              <div style={{ fontSize: "12px", color: "var(--color-muted-green)", marginBottom: "6px" }}>
              ...
              <ul style={{ margin: 0, paddingLeft: "18px", fontSize: "12px", color: "var(--color-primary-dark)", lineHeight: "1.6" }}>
          ...
          <div style={{ marginBottom: "20px" }}>
            <b style={{ color: "var(--color-primary-dark)", fontSize: "13px", display: "block", marginBottom: "8px" }}>
              4. Physical Barrier Compliance Matrix
            </b>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "12.5px" }}>
              <thead>
                <tr style={{ background: "var(--color-bg-base)", borderBottom: "1px solid var(--border-color)", textAlign: "left" }}>
              ...
              <tbody>
                <tr style={{ borderBottom: "1px solid var(--border-color)" }}>
                  ...
                  <td style={{ padding: "8px 10px", color: "var(--color-muted-green)", fontWeight: 700 }}>+{top.barrier_check?.otr_margin_pct}%</td>
                ...
                <tr style={{ borderBottom: "1px solid var(--border-color)" }}>
                  ...
                  <td style={{ padding: "8px 10px", color: "var(--color-muted-green)", fontWeight: 700 }}>+{top.barrier_check?.wvtr_margin_pct}%</td>
                  <td style={{ padding: "8px 10px" }}><span className="badge-pass">PASS</span></td>
                </tr>
              </tbody>
            </table>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "14px", marginBottom: "20px" }}>
            <div style={{ background: "var(--color-bg-base)", padding: "12px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-color)" }}>
              <span className="micro-label">Predicted Shelf Life</span>
              <b style={{ display: "block", color: "var(--color-muted-green)", fontSize: "16px", margin: "4px 0 2px" }}>
            ...
            <div style={{ background: "var(--color-bg-base)", padding: "12px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-color)" }}>
              ...
              <b style={{ display: "block", color: "var(--color-primary-dark)", fontSize: "16px", margin: "4px 0 2px" }}>
          ...
          <div style={{ background: "var(--color-bg-base)", padding: "16px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-color)", marginBottom: "20px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
              <b style={{ color: "var(--color-data-slate)", fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                5. Machine Learning Model Architecture & Performance
              </b>
              <span style={{ fontSize: "10.5px", padding: "2px 8px", borderRadius: "var(--radius-full)", background: "rgba(213, 154, 56, 0.15)", color: "var(--color-warning-amber)", border: "1px solid rgba(213, 154, 56, 0.3)" }}>
                PROTOTYPE MODEL
              </span>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "10px", fontSize: "12px", marginBottom: "10px" }}>
              <div>
                ...
                <b style={{ color: "var(--color-primary-dark)" }}>{result.ml_model_metadata?.model || "Random Forest"}</b>
              </div>
              <div>
                <span style={{ color: "var(--text-muted)", fontSize: "10.5px", display: "block" }}>TRAINING SAMPLES:</span>
                <b style={{ color: "var(--color-muted-green)" }}>{result.ml_model_metadata?.training_samples || "2000 prototype samples"}</b>
              </div>
              <div>
                <span style={{ color: "var(--text-muted)", fontSize: "10.5px", display: "block" }}>INPUT FEATURES:</span>
                <b style={{ color: "var(--color-primary-dark)" }}>{result.ml_model_metadata?.input_features || "Food + packaging + storage parameters"}</b>
              </div>
              <div>
                <span style={{ color: "var(--text-muted)", fontSize: "10.5px", display: "block" }}>OUTPUTS:</span>
                <b style={{ color: "var(--color-data-slate)" }}>{result.ml_model_metadata?.outputs || "Packaging suitability"}</b>
              </div>
              <div>
                <span style={{ color: "var(--text-muted)", fontSize: "10.5px", display: "block" }}>METRICS (R² / MAE):</span>
                <b style={{ color: "var(--color-muted-green)" }}>R² {result.ml_model_metadata?.test_r2_score || "0.94"} · MAE {result.ml_model_metadata?.test_mae || "0.038"}</b>
              </div>
            </div>

            <div style={{ fontSize: "11px", color: "var(--color-primary-dark)", background: "rgba(213, 154, 56, 0.12)", padding: "8px 12px", borderRadius: "var(--radius-sm)", border: "1px solid rgba(213, 154, 56, 0.35)", lineHeight: "1.45" }}>
